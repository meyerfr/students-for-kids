...
class SittersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sitter" do
    assert_difference('Sitter.count') do
      post sitters_url, params: { sitter: { age: @sitter.age, contract_data_id: @sitter.contract_data_id } }
    end
  ...
  test "should update sitter" do
    patch sitter_url(@sitter), params: { sitter: { age: @sitter.age, contract_data_id: @sitter.contract_data_id } }
